...
const IncomeList = ({ incomes = [], onEdit, onDelete }) => {
  ...
  // Toggle Sort and Filter Dropdowns
  ...
  const filteredIncomeCategory = selectedCategories.length
    ? incomes.filter((income) =>
        selectedCategories.includes(income.category)
      )
    : incomes;
  
  const sortedIncomes = sortOrder
    ? [...filteredIncomeCategory].sort((a, b) => {
      ...
      <div className="flex items-center justify-between gap-2 bg-[#F9FAFB] py-4 px-4 rounded-md">
        ...
        <div className="flex gap-1">
          ...
          <div className="relative inline-block text-left">
            ...
            {isSortOpen && (
              <div
                className="absolute z-10 mt-2 -left-16 w-36 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                role="menu"
